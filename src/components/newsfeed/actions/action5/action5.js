        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col">
              ...
              <p className={styles.content}>Η σημερινή δράση θα μπορούσε να θεωρηθεί προέκταση προηγούμενης δράσης αλλά και προάγγελος επόμενης, μιας και εκατέρωθεν του παράδρομου της Ολυμπίας οδού, μετά τη γέφυρα της Αγίου Χαραλάμπους, έχουν συσσωρευτεί μη-οικιακά απορρίμματα χρόνων!</p>
              <p className={styles.content}>Επιλέξαμε να ξεκινήσουμε από ένα πολύ επιβαρυμένο σημείο, κοντά σε μια γειτονιά, που έχει την ατυχία να συνορεύει με άδεια ή εγκαταλελειμμένα οικόπεδα και παρ’ όλες τις δικές τους προσπάθειες καθαρισμού, ο όγκος απορριμμάτων ήταν τέτοιος που χρειάστηκε την επέμβαση 9 εθελοντών της Εθελοντικής Ομάδας Δράσης. </p>
              ...
              <p className={styles.content}>Συμμετέχοντες :	Αβραμίδου Ελευθερία, Γεροχριστοδούλου Βαρβάρα, Λίτσα Ρούλα,Μέγα Βάνα, Νάκου Κατερίνα, Ξυγκάκη Αναστασία,Πανταζοπούλου Γιώτα, Παπαδόπουλος Ορέστης και Πυρομάλλη Άννα. </p>
