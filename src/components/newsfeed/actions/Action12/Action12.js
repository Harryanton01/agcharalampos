      ...
      <CardContent>
        <div class="container">
          <div class="row">
            ...
            <div class="col-4">
              <p className={styles.details}>Σάββατο 17, Κυριακή 18 & Σάββατο 24 & 31 Οκτωβρίου 2020</p>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col">
              ...
              Ο καθαρισμός της οδού Αγίων Αναργύρων, από την οδό Αγίου Χαραλάμπους έως και το γραφείο του συλλόγου μας, διήρκησε 4 ημέρες, συνολικά 10 ώρες και απασχόλησε 12 εθελοντές.  
</p>
              <p className={styles.content}>Η βλάστηση εκατέρωθεν της οδού ήταν ανεξέλεγκτη και τα αγριόχορτα είχαν καταλάβει το οδόστρωμα και είχαν μετατρέψει το δρόμο όπου βρίσκεται το γραφείο του συλλόγου μας σε ζούγκλα,  ενώ ανάμεσά τους υπήρχαν διάσπαρτα μη οικιακά απορρίμματα.
  </p>
              <p className={styles.content}>Συμμετέχοντες :	Αβραμίδου Ελευθερία Βακιρτζής Χρόνης, Κωνσταντίνου Ιωάννα, Λαιμός Κωνσταντίνος, Νάκου Κατερίνα,  Ξυγκάκη Αναστασία, Πανταζοπούλου Γιώτα, Πρίφτη Βιολέτα, Πρίφτης Αχιλλέας, Ρυμική Βούλα, ο Άγγελος και ο Δήμος.
 </p>
