        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col">
              ...
              <p className={styles.content}>
                Ο κ. Βαλμάς, μετά την μακράς διάρκειας συνομιλίας τους,
                κατανόησε πλήρως την αποφασιστικότητα του συλλόγου μας να
                προσφέρει στους κατοίκους της περιοχής μας όσο το δυνατόν
                ποιοτικότερες συνθήκες ζωής, και αξιολογώντας τα έως τώρα
                αποτελέσματα του έργου μας, προχώρησε σε μία συγκλονιστική
                προσφορά!
              </p>
              <p className={styles.content} style={{ color: "red" }}>
                ΔΩΡΕΑΝ ΚΑΡΤΑ ΥΓΕΙΑΣ για όλα τα Μέλη του Συλλόγου μας και τα
                εξαρτώμενα πρόσωπά τους στα Ιδιωτικά Νοσηλευτικά Ιδρύματα
                Metropolitan Hospital & Metropolitan General, που περιλαμβάνει
                αξιόλογες εκπτώσεις και μοναδικές προσφορές, καλύπτοντας όλο το
                φάσμα των ιατρικών επισκέψεων και εξετάσεων!
              </p>
              <p className={styles.content}>
                Γι’ αυτήν την τεράστια κοινωνική προσφορά, ο σύλλογός μας
                <span style={{ color: "red" }}>
                  {" "}
                  κατατάσσει τα Metropolitan Hospital & Metropolitan General
                  στους ΑΣΗΜΕΝΙΟΥΣ ΧΟΡΗΓΟΥΣ !{" "}
                </span>
              </p>

              <p className={styles.content}>
                Ο πρόεδρός μας και το Δ.Σ. του συλλόγου μας, εκπροσωπώντας τους
                κατοίκους της περιοχής μας, Ευχαριστούν Θερμά.
                <span style={{ color: "red" }}>
                  {" "}
                  Τα Metropolitan Hospital & Metropolitan General,{" "}
                </span>
                και ειδικότερα τον εκπρόσωπό τους
                <span style={{ color: "red" }}> κ. Δημήτρη Βαλμά, </span>
                για την ευγενική προσφορά, την αμέριστη υποστήριξη, και την
                αναγνώριση της προσπάθειας που καταβάλουμε, δείχνοντας έμπρακτα
                την κοινωνική τους ευαισθησία για τον κοινό μας πλέον στόχο!
              </p>
