        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col">
              ...
              <p className={styles.content}>Ο κ. Γρηγοράτος, αξιολογώντας τα έως τώρα αποτελέσματα και διακρίνοντας την αποφασιστικότητα να παράγουμε έργο, προχώρησε στην 
              <span style={{color:'red'}}> Ευγενική Χορηγία του Νέου Φωτεινού Διακόσμου,
που θα στολίζει  Χριστούγεννα & Πάσχα τους δρόμους της περιοχής  μας. </span>
 Έτσι, δικαίως  ο σύλλογός μας  
<span style={{color:'red'}}> κατατάσσει την εταιρεία ΔΗΜΗΤΡΙΑΚΗ Α.Ε.  στους 
...
την εταιρεία <span style={{color:'red'}}>ΔΗΜΗΤΡΙΑΚΗ Α.Ε. </span> 
και  ειδικότερα τον Δ/ντα Σύμβουλο της <span style={{color:'red'}}>κ. Σ. Γρηγοράτο </span> 
