          ...
          <div class="row">
            <div class="col">
              ...
              <p className={styles.content}>
                Σήμερα ξεκίνησε ο καθαρισμός και η περίφραξη των «παράνομων
                χωματερών» της περιοχής μας, από την συμβολή των οδών Κανάρη &
                Παλαιάς Εθνικής Οδού, στο ύψος του ρέματος.
              </p>
              <p className={styles.content}>
                Η βοήθεια του Δήμου ήταν καθοριστική σ’ αυτή την πρώτη μας
                προσπάθεια και το αποτέλεσμα μας έδωσε δύναμη για να συνεχίσουμε
                !
              </p>
              <img
                src={img1}
