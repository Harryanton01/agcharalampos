          ...
          <div class="row">
            <div class="col">
              ...
              <p className={styles.content}>
                Ολοκληρώθηκε ο καθαρισμός εκατέρωθεν της οδού Αγίου Χαραλάμπους
                στο ύψος της γέφυρας και εν συνεχεία τμήματος του παράδρομου της
                Ολυμπίας Οδού.
              </p>
              <p className={styles.content}>
                Τα συσσωρευμένα απορρίμματα είχαν καταλήξει στα σιφώνια απορροής
                των όμβριων υδάτων και τα είχαν φράξει σε τέτοιο βαθμό που
                καθιστούσε επικίνδυνο τον πλημμυρισμένο δρόμο κάθε φορά που
                έβρεχε.
              </p>
              <p className={styles.content}>
                Συμμετέχοντες : Αβραμίδου Ελευθερία, Βακιρτζή Χρόνη, Λαιμό
                Κωνσταντίνο, Λίτσα Ρούλα, Νάκου Κατερίνα, Ξυγκάκη Αναστασία,
                Πανταζοπούλου Γιώτα, Πρίφτη Βιολέτα, Πρίφτη Αχιλλέα και Ρυμική
                Βούλα.{" "}
              </p>
              <img
                src={img1}
