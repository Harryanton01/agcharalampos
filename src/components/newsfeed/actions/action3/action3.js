      ...
      <CardContent>
        <div class="container">
          <div class="row">
            ...
            <div class="col-4">
              <p className={styles.details}>
                Πέμπτη 1 Οκτωβρίου 2020 έως Κυριακή 4 Οκτωβρίου 2020
              </p>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col">
              ...
              <p className={styles.content}>
                Η τρίτη «παράνομη χωματερή» της περιοχής μας που καθαρίζεται και
                περιφράσσεται, βρίσκεται επί της οδού Αγάπης, και είναι ίσως η
                δεύτερη μεγαλύτερη της περιοχής μας!
              </p>
              <p className={styles.content}>
                Κι εδώ συσσωρευμένα και θαμμένα κάτω από το χώμα απορρίμματα
                χρόνων και περίπου 10 ώρες δουλειάς από 14 εθελοντές, που
                δούλεψαν με πάρα πολύ όρεξη και καθάρισαν όλη την οδό μέχρι την
                παιδική χαρά!{" "}
              </p>
              <p className={styles.content}>
                Η βοήθεια του Δήμου ήταν κι εδώ καθοριστική! Ο πρώτος καθαρισμός
                των βουνών από μη-οικιακά απορρίμματα και κλαδιά, έγινε από την
                μπουλντόζα του Δήμου και στη συνέχεια οι εθελοντές μας
                ολοκλήρωσαν τον καθαρισμό και την περίφραξη του χώρου, με την
                ελπίδα να μη δούμε ποτέ ξανά τέτοιες εικόνες!
              </p>
              <p className={styles.content}>
                Συμμετέχοντες : Αβραμίδου Ελευθερία, Βακιρτζή Φωτεινή, Βακιρτζής
                Χρόνης, Γεροχριστοδούλου Βαρβάρα, Κέμος Νίκος, Λαιμός
                Κωνσταντίνος, Μπαναγκής Βασίλης, Μύριλλας Χρήστος, Νάκου
                Κατερίνα, Ξυγκάκη Αναστασία, Πανταζοπούλου Γιώτα, Παραστατίδης
                Γιώργος, Πυρομάλλη Άννα και Ρυμήκη Βούλα{" "}
              </p>
