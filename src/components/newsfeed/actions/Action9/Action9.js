        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col">
              ...
              <p className={styles.content}>
                Με πρωταρχικό στόχο να απαλλάξουμε τον οικισμό από κάθε είδους
                «άτυπων χωματερών», του ανέλυσε το πρόγραμμά μας που βασίζεται
                στη σωστή ενημέρωση και ευαισθητοποίηση των κατοίκων , στην
                αδιάλειπτη συνεργασία με τον αντιδήμαρχο κ. Σωτήρη Πέρρα και την
                υπηρεσία καθαριότητας του δήμου αλλά και τη δημιουργία της
                Εθελοντικής Ομάδας, που η συνεργασία τους έχει ήδη δώσει
                δείγματα δράσεων καθαρισμού, με θαυμάσια αποτελέσματα.
              </p>
              <p className={styles.content}>
                Ο κ. Δημήτρης Κανελλόπουλος, αξιολογώντας τα έως τώρα
                αποτελέσματα και διακρίνοντας την αποφασιστικότητα όλων των
                εμπλεκόμενων πλευρών να παράγουν έργο, προχώρησε στην{" "}
                <span style={{ color: "red" }}>
                  Ευγενική Χορηγία 11 συνολικά πινακίδων,
                </span>
                που αφορούν την απαγόρευση απόρριψης απορριμμάτων και την
                ανάδειξη της περιοχής μας. Έτσι ο σύλλογός μας{" "}
                <span style={{ color: "red" }}>
                  κατατάσσει την εταιρεία Motor Oil στους ΧΡΥΣΟΥΣ ΧΟΡΗΓΟΥΣ{" "}
                </span>{" "}
                του οικισμού μας!
              </p>
              ...
              <p className={styles.content}>
                ...
                κατοίκους της περιοχής μας, Ευχαριστούν Θερμά την εταιρεία Motor
                Oil και ειδικότερα τον διευθυντή της κ. Δημήτρη Κανελλόπουλο για
                την ευγενική προσφορά, την αμέριστη υποστήριξη, και την
