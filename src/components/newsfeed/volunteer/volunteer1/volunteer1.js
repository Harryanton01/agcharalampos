...
Την Κυριακή 1 Νοεμβρίου 2020 , στην όμορφη παραλία Αγάπης, 
η  Εθελοντική Ομάδα Δράσης της περιοχής μας 
παρέλαβε την Επίσημη Ενδυμασία της, 
προσφορά του προέδρου του Συλλόγου μας Κωνσταντίνου Λαιμού!

</p>
              <p className={styles.content}>Το σύνθημα της Εθελοντικής Ομάδας Δράσης
 <span style={{color:lightBlue}}>«Είμαστε όλοι μαζί, είμαστε δυνατοί !»</span> , αποτυπώθηκε σε μια πολύχρωμη ροζέτα, ενώ δεν θα μπορούσε να λείπει το σχετικό κοινωνικό μήνυμα 
που έχει αποτυπωθεί και στις Κάρτες Μέλους του συλλόγου μας και αποτελεί πλέον αναπόσπαστο κομμάτι της Επίσημης Ενδυμασίας των Εθελοντών μας!

  </p>
  <p className={styles.content}>
  Ακολούθησε ατομική  φωτογράφιση των παρευρισκομένων Εθελοντών , αλλά και ομαδική, τηρώντας τις απαραίτητες αποστάσεις, προκειμένου να στείλουν το δικό τους μήνυμα, σε μια εποχή που λόγω covid19 οι αποστάσεις μεταξύ μας για να μείνουμε ασφαλείς επιβάλλονται !
  </p>
  <p className={styles.content}>
  Στην παραλαβή του εξοπλισμού τους παρευρέθηκαν οι Εθελοντές 
που κατά κύριο λόγο διαμένουν στον οικισμό μας.
Για όλους τους υπόλοιπους που απουσίαζαν, θα προγραμματιστεί στο μέλλον νέα εκδήλωση για την παραλαβή του εξοπλισμού τους  και συμπληρωματική φωτογράφηση. 
