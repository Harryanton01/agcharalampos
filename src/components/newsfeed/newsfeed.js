...
function Newsfeed() {
  ...
  return(
    ...
    <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
      <AccordionSummary expandIcon={<ExpandMoreIcon />}>
        <h4>-ΑΠΟΚΡΙΕΣ 2021 ΣΤΟΝ ΑΓΙΟ ΧΑΡΑΛΑΜΠΟ – ΕΞΩΡΑΪΣΤΙΚΟΣ ΠΟΛΙΤΙΣΤΙΚΟΣ ΣΥΛΛΟΓΟΣ “ΑΓΙΟΣ ΧΑΡΑΛΑΜΠΟΣ”</h4>
      </AccordionSummary>
        <AccordionDetails>
          <Article11 />
        </AccordionDetails>
    ...
    <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
      <AccordionSummary expandIcon={<ExpandMoreIcon />}>
        <h4>Καλαμάκι Κορινθίας: Μια εθελοντική πρωτοβουλία που αξίζει συγχαρητήρια</h4>
      </AccordionSummary>
        <AccordionDetails>
          <Article12 />
        </AccordionDetails>
    ...
    <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
      <AccordionSummary expandIcon={<ExpandMoreIcon />}>
        <h4>10 ΦΕΒΡΟΥΑΡΙΟΥ 2021 ΕΟΡΤΑΣΜΟΣ ΑΓΙΟΥ ΧΑΡΑΛΑΜΠΟΥΣ
</h4>
      </AccordionSummary>
        <AccordionDetails>
          <Article14 />
    ...
    <Accordion onChange={handleChange('panel1')}>
      <AccordionSummary expandIcon={<ExpandMoreIcon />}>
        <h4>ΡΕΠΟΡΤΑΖ zougla.gr : Η Περιφέρεια Πελοποννήσου νίπτει τας χείρας της για την περιβαλλοντική καταστροφή στην παραλία «Αγάπη»</h4>
      </AccordionSummary>
        <AccordionDetails>
          <Article9 />
        </AccordionDetails>
    ...
    <Accordion  onChange={handleChange('panel1')}>
      <AccordionSummary expandIcon={<ExpandMoreIcon />}>
        <h4>Ο δραστήριος σύλλογος «Άγιος Χαράλαμπος» Καλαμάκι Ισθμία Κορινθίας</h4>
      </AccordionSummary>
        <AccordionDetails>
          <Article7 />
        </AccordionDetails>
    ...
    <Accordion  onChange={handleChange('panel1')}>
      <AccordionSummary expandIcon={<ExpandMoreIcon />}>
        <h4>Αναφορά στη  ΣΥΝΕΧΙΖΟΜΕΝΗ περιβαλλοντική μόλυνση της περιοχής μας - ΝΟΕΜΒΡΙΟΣ 2020</h4>
      </AccordionSummary>
        <AccordionDetails>
          <Article8 />
        </AccordionDetails>
    ...
    <Accordion>
      <AccordionSummary expandIcon={<ExpandMoreIcon />}>
        <h4>Αναφορά στην περιβαλλοντική μόλυνση της περιοχής μας - 26/08/2020</h4>
      </AccordionSummary>
        <AccordionDetails>
          <Article2 />
        </AccordionDetails>
