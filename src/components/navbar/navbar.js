    ...
    <Navbar variant="dark" expand="lg">
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="mr-auto">
          ...
          <NavDropdown
            className={styles.navLink}
            title="ΝΕΑ, ΔΡΑΣΕΙΣ &amp; ΑΝΑΚΟΙΝΩΣΕΙΣ"
            id="collasible-nav-dropdown"
          >
          ...
          <NavDropdown
            className={styles.navLink}
            title="ΠΡΟΣΦΟΡΕΣ ΓΙΑ ΤΑ ΜΕΛΗ"
            id="collasible-nav-dropdown"
          >
            <NavDropdown.Item href="/discounts">ΠΡΟΣΦΟΡΕΣ</NavDropdown.Item>
            <NavDropdown.Item href="/member-announcements">
              ΝΕΑ & ΕΝΗΜΕΡΩΣΕΙΣ ΜΕΛΩΝ
            </NavDropdown.Item>
          </NavDropdown>
          <NavDropdown
            className={styles.navLink}
            title="ΕΘΕΛΟΝΤΙΚΗ ΟΜΑΔΑ"
            id="collasible-nav-dropdown"
          >
            <NavDropdown.Item href="/volunteer">ΕΚΔΗΛΩΣΕΙΣ</NavDropdown.Item>
            <NavDropdown.Item href="/volunteer-images">
              ΦΩΤΟΓΡΑΦΙΕΣ ΕΘΕΛΟΝΤΩΝ
            </NavDropdown.Item>
            <NavDropdown.Item href="/volunteer-about-us">
              ΕΛΑ ΜΑΖΙ ΜΑΣ
            </NavDropdown.Item>
          </NavDropdown>
          <NavDropdown
          ...
          >
            ...
            <NavDropdown.Item href="/sponsor-announcements">
              ΕΝΗΜΕΡΩΣΕΙΣ- ΣΤΙΓΜΙΟΤΥΠΑ
            </NavDropdown.Item>
          </NavDropdown>
        </Nav>
      </Navbar.Collapse>
