...
class User extends React.Component {
        ...
        if(form.checkValidity() === true){
          ...
          const mailRef = db.collection('mail').add({
            ...
            message:{
                ...
                '<strong>ΜΥΝΗΜΑ</strong>: '+this.state.message+'<br>',
            }
           });
          this.setState({
            ...this.state,
  ...
  <Form.Group controlId="address">
    ...
    <Form.Control type="text" placeholder="" onChange={this.updateInput}/>
  </Form.Group>
  ...
  <Form.Group controlId="message">
    ...
    <Form.Control as='textarea' rows='4' placeholder="Τα σχόλιά σου..." required onChange={this.updateInput}/>
    <Form.Control.Feedback type="invalid">
  ...
  <Form.Group controlId="formBasicCheckbox">
    <Form.Check required type="checkbox" label="Αποδέχομαι την επεξεργασία των προσωπικών μου στοιχείων για τις ανάγκες του συλλόγου" />
  </Form.Group>
  <Form.Text className="text-muted">
      * Υποχρεωτικό πεδίο...
    </Form.Text>
